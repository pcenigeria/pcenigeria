...
export const PerformanceMatrix: React.FC<PerformanceMatrixProps> = ({ section, matrixRows }) => {
    ...
    const rows = (matrixRows && matrixRows.length > 0)
        ? matrixRows
        : (section?.matrixRows && section.matrixRows.length > 0)
            ? section.matrixRows
            : DEFAULT_MATRIX_DATA;
